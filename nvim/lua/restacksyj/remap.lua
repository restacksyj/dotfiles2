...
-- vim.keymap.set("n", "<leader>yfp", "<cmd>let @+ = @%:p | echo 'Copied filepath'<CR>")
vim.keymap.set("n", "<leader>yfp", "<cmd>let @+ = expand('%:p') | echo 'Copied filepath'<CR>")
...
vim.keymap.set("n", "<leader>vv", "<cmd>VimtexView<CR>")
vim.keymap.set("n", "<leader>zz", "<cmd>SimpleZoomToggle<CR>")
...
--end, { silent = true })
-- vim.keymap.set("n", "<leader>od", "<cmd>Oil ~/Downloads/<CR>")
